...
import { isCategoriesValid, isNameValid, isValidForm } from "./validators";
...
const ProductForm = (props) => {
  ...
  const onSubmit = (e) => {
    ...
    console.log("ezaeza", Object.keys(isValidForm(data)).length);
    if (!Object.keys(isValidForm(data)).length > 0) props.onSave(data);
    else
  ...
  return (
    <Form onSubmit={onSubmit}>
      ...
      <FormGroup>
        ...
        <Input
          invalid={ErrorHandlers["categories"]}
          type="select"
          name="categories"
          id="categories"
          multiple
